...
public class ModificarDatos extends javax.swing.JFrame {
  ...
  int num_cliente;
    ...
    private void initComponents() {
        ...
        jLabel6.setText("Atencion Especia:");

        jLabel7.setText("Nombre Dueno:");

        jLabel8.setText("Cel Dueno:");
        ...
        jLabel10.setIcon(new javax.swing.ImageIcon("C:\\Users\\kelvi\\OneDrive - IPCHILE - Instituto Profesional de Chile\\Documentos\\NetBeansProjects\\peluqueriaCanina\\peluqueriaCanina\\src\\main\\java\\img\\logoPeluqueriaCanina.jpg")); // NOI18N
    ...
    private void btnGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGuardarActionPerformed
       // Datos de la Mascota
        ...
        String atenEsp= (String)cmbAtencionEs.getSelectedItem();
        
         //Datos del duenio       
        String nombDueno = txtNombreDueno.getText();
        String celDueno=txtCelDueno.getText();
        
        
        control.modificarMascota(masco, nombreMasco, raza, color, observaciones, alergico, atenEsp,nombDueno,celDueno);
      ...
      //mensaje
       ...
       mostrarMensaje("Edicion realizada correctamente", "Info","Edicion correcta");
         ...
         //Abrir la pantalla de ver datos
         VerDatos pantalla=new VerDatos();
         pantalla.setVisible(true);
         pantalla.setLocationRelativeTo(null);
         
        //Para que se cierre la ventana despues de editar
         this.dispose();    
    ...
    private void cargarDatos(int num_cliente) {
         this.masco = control.traerMascota(num_cliente);
            ...
            txtCelDueno.setText(masco.getUnDueno().getCel_dueno());
            txtObservaciones.setText(masco.getObservasiones());
            ...
            }else if(masco.getAlegico().equals("NO")){
